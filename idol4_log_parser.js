...
var CAMERA_TAKE_PICTURE_DONE_HAL_QCOM = 'PROFILE_JPEG_CB';
...
/*Camera Launch*/
var CAMERA_OPEN_START_TOKEN = UNKNOWN_TOKEN;
var CAEMRA_OPEN_END_TOKEN = UNKNOWN_TOKEN;

var CAMERA_OPEN_START_TOKEN_HAL = CAMERA_OPEN_TOKEN_HAL_QCOM;
var CAEMRA_OPEN_END_TOKEN_HAL = CAMERA_PREVIEW_FIRST_FRAME_HAL_QCOM;

/*Mode switch*/
var CAMERA_MODE_SWITCH_START_TOKEN = 'KPI start mode selecting';
var CAEMRA_MODE_SWITCH_END_TOKEN = 'KPI on surfaceTexture updated';

var CAMERA_MODE_SWITCH_START_TOKEN_HAL = CAMERA_PREVIEW_STOP_TOKEN_HAL_QCOM;
var CAEMRA_MODE_SWITCH_END_TOKEN_HAL = CAMERA_PREVIEW_FIRST_FRAME_HAL_QCOM;

/*Camera Switch*/
var CAMERA_TOGGLE_START_TOKEN = UNKNOWN_TOKEN;
var CAMERA_TOGGLE_END_TOKEN = UNKNOWN_TOKEN;

var CAMERA_TOGGLE_START_TOKEN_HAL =CAMERA_PREVIEW_STOP_TOKEN_HAL_QCOM;
var CAMERA_TOGGLE_END_TOKEN_HAL = CAEMRA_OPEN_END_TOKEN_HAL_QCOM;

/*Take Picture*/
var CAMERA_TAKE_PICTURE_START_TOKEN = 'KPI shutter click';
var CAMERA_TAKE_PICTURE_END_TOKEN = 'onPictureTaken, camera state is';
...
var CAMERA_BURST_TOKEN_HAL = CAMERA_TAKE_PICTURE_DONE_HAL_QCOM;

/*Video*/
var CAMERA_CAPTURE_VIDEO_START_TOKEN = UNKNOWN_TOKEN;
var CAMERA_CAPTURE_VIDEO_END_TOKEN = UNKNOWN_TOKEN;

var CAMERA_CAPTURE_VIDEO_START_TOKEN_HAL = UNKNOWN_TOKEN;
var CAMERA_CAPTURE_VIDEO_END_TOKEN_HAL = UNKNOWN_TOKEN;
...
var CAMERA_INSTANT_CAPTURE_UI_END_TOKEN = UNKNOWN_TOKEN;
...
idol4_log_parser.set_platform = function(plat) {
	if (plat.indexOf('mtk') >= 0){
 		...
 		CAEMRA_OPEN_END_TOKEN_HAL = CAMERA_PREVIEW_FIRST_FRAME_HAL_MTK;

		CAMERA_MODE_SWITCH_START_TOKEN_HAL = CAMERA_PREVIEW_STOP_TOKEN_HAL_MTK;
		CAEMRA_MODE_SWITCH_END_TOKEN_HAL = CAMERA_PREVIEW_FIRST_FRAME_HAL_MTK;

		CAMERA_TOGGLE_START_TOKEN_HAL =CAMERA_PREVIEW_STOP_TOKEN_HAL_MTK;
		CAMERA_TOGGLE_END_TOKEN_HAL = CAEMRA_OPEN_END_TOKEN_HAL_MTK;
		...
		CAMERA_INSTANT_CAPTURE_END_TOKEN_HAL = CAMERA_TAKE_PICTURE_DONE_HAL_MTK;
 		...
 		CAEMRA_OPEN_END_TOKEN_HAL = CAMERA_PREVIEW_FIRST_FRAME_HAL_QCOM;

		CAMERA_MODE_SWITCH_START_TOKEN_HAL = CAMERA_PREVIEW_STOP_TOKEN_HAL_QCOM;
		CAEMRA_MODE_SWITCH_END_TOKEN_HAL = CAMERA_PREVIEW_FIRST_FRAME_HAL_QCOM;

		CAMERA_TOGGLE_START_TOKEN_HAL =CAMERA_PREVIEW_STOP_TOKEN_HAL_QCOM;
		CAMERA_TOGGLE_END_TOKEN_HAL = CAEMRA_OPEN_END_TOKEN_HAL_QCOM;
...
idol4_log_parser.parseLaunchTimeCold = function(content){
	...
	this._parse(content, CAMERA_OPEN_START_TOKEN_HAL, CAEMRA_OPEN_END_TOKEN_HAL, "--Time For Camera Launch(Cold)-(HAL)--");
}
...
idol4_log_parser.parseLaunchTimeWarm = function(content){
	...
	this._parse(content, CAMERA_OPEN_START_TOKEN_HAL, CAEMRA_OPEN_END_TOKEN_HAL, "--Time For Camera Launch(Warm)-(HAL)--");
}
...
idol4_log_parser.parseSwitchMode = function(content){
	...
	this._parse(content, CAMERA_PREVIEW_STOP_TOKEN_HAL, CAEMRA_OPEN_END_TOKEN_HAL, "--Time For Switch Mode-(HAL)--");
}
...
idol4_log_parser.parseSwitchCamera = function(content){
	...
	this._parse(content, CAMERA_PREVIEW_STOP_TOKEN_HAL, CAEMRA_OPEN_END_TOKEN_HAL, "--Time For Toggle Camera-(HAL)--");
}
