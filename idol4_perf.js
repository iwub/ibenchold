...
idol4_perf.profile_launch_speed = function(cold){
	start_test(function(){
		perform_launch_iteration(cold);
	});
};

idol4_perf.profile_launch_speed_cold = function(){
	start_test(function(){
		perform_launch_iteration(true);
	});
};

idol4_perf.profile_launch_speed_warm = function(){
	start_test(function(){
		perform_launch_iteration(false);
	});
};

idol4_perf.profile_take_picture = function (){
	start_test(function(){
...
idol4_perf.profile_toggle = function (){
	start_test(function(){
		cp.exec(cmdLaunchCamera);
...
idol4_perf.profile_mode = function (){
	start_test(function(){
		cp.exec(cmdLaunchCamera);
...
idol4_perf.profile_boom_capture = function (){
	start_test(function(){
		setTimeout(perform_instant_capture, 1000);
	});	
}

module.exports = idol4_perf;
